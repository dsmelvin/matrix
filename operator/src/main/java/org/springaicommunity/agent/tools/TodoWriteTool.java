...
public class TodoWriteTool {
    ...
    public String todoWrite( @ToolParam(description = "The list of todo items")
                             List<TodoWriteTool.Todos.TodoItem> todos) { // @formatter:on

        validateTodos(new TodoWriteTool.Todos(todos));
        this.todoListConsumer.handle(new TodoWriteTool.Todos(todos));
