...
public class ChatMemoryService {
    ...
    public void addChatMemory(String conversationId, Generation generation) {
        if (generation != null) {
            addChatMemory(conversationId, generation.getOutput());
        }
    }
    ...
    public void removeChatMemory(String conversationId) {
