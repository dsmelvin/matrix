...
import guru.kumo.operator.tool.agent.task.repository.BackgroundTask;
...
public class TaskOutputTool {
	...
	public static class TaskOutputFunction implements Function<TaskOutputCall, String> {
		...
		public String apply(TaskOutputCall taskOutputCall) {
			...
			long timeoutMs = taskOutputCall.timeout() != null ? Math.min(taskOutputCall.timeout(), 1800_000) : 300_000;
